...
import uz.perfectalgorithm.projects.tezkor.databinding.FragmentSelectStaffBelowBinding
...
/**
 *Created by farrukh_kh on 10/1/21 10:45 PM
 *uz.perfectalgorithm.projects.tezkor.presentation.ui.screens.home_activity.dashboard.select_person
 **/
/**
 * Dashboard uchun barcha xodimlar orasidan tanlash oynasi
 * tanlangan xodimni DashboardSelectPersonFragment ga uzatadi
 */
@AndroidEntryPoint
class StaffBelowSelectFragment : Fragment(), FragmentPageSelectedListener {

    // TODO: 8/26/21 needs performance optimization
    private var _binding: FragmentSelectStaffBelowBinding? = null
    private val binding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSelectStaffBelowBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun initObservers() {
        viewModel.staffBelow.simpleCollectWithRefresh(
            this,
            binding.srlRefresh,
            binding.tvEmpty
        ) { workers ->
