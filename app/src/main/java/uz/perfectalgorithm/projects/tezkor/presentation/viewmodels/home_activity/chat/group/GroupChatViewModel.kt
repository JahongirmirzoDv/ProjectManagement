package uz.perfectalgorithm.projects.tezkor.presentation.viewmodels.home_activity.chat.group
...
/**
 * Created by Davronbek Raximjanov on 22.09.2021 11:47
 **/
...
class GroupChatViewModel @Inject constructor(
    ...
    fun getChatList() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            repository.getGroupChatList().collect {
