package uz.perfectalgorithm.projects.tezkor.presentation.viewmodels.home_activity.chat.project
...
@HiltViewModel
class ProjectGroupChatViewModel @Inject constructor(
    ...
    fun getChatList() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            repository.getProjectChatList().collect {
