...
@AndroidEntryPoint
class ShowImageMsgDialog(
    private val messageData: PersonalChatMessageListResponse.MessageDataItem,
    private val senderFullName: String
) : DialogFragment() {
    ...
    private var listenDelete: SingleBlock<PersonalChatMessageListResponse.MessageDataItem>? =
        null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            txtSenderName.text = senderFullName
    ...
    fun deleteClickListener(f: SingleBlock<PersonalChatMessageListResponse.MessageDataItem>) {
        listenDelete = f
    }
