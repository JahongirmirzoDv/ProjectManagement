...
class StructureLeaderForChatAdapter(private val positionsItem: StructureResponse.PositionsItem) :
    ListAdapter<AllWorkersResponse.DataItem, StructureLeaderForChatAdapter.VH>(DIFF_CHANNEL_CALLBACK) {
