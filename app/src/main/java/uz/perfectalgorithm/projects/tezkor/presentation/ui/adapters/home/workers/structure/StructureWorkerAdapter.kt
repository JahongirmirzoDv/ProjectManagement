...
class StructureWorkerAdapter(private val positionsItem: StructureResponse.PositionsItem) :
    ListAdapter<AllWorkersResponse.DataItem, StructureWorkerAdapter.VH>(DIFF_CHANNEL_CALLBACK) {
